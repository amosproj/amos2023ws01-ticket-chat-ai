...
from app.dependency.t5_for_conditional_generation import (
...
def get_trained_t5_model(
    model: T5ForConditionalGeneration = Depends(get_t5_for_conditional_generation),
    tokenizer: T5Tokenizer = Depends(get_t5_tokenizer),
) -> TrainedT5Model:
