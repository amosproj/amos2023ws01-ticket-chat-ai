...
class CategoryDBRoutineServiceUnitTest(TestCase):
    def setUp(self):
        ...
        self.category_db_service = CategoryDBRoutineService(
            category_repository=self.category_repository_mock
        )
    ...
    def test_start_routine(self):
        ...
        self.assertEqual(
            6,
            len(self.category_repository_mock.create_category.mock_calls),
