...
class LocationDBRoutineServiceUnitTest(TestCase):
    def setUp(self):
        ...
        self.location_db_service = LocationDBRoutineService(
            location_repository=self.location_repository_mock
        )
    ...
    def test_start_routine(self):
        ...
        self.assertEqual(
            5,
            len(self.location_repository_mock.create_location.mock_calls),
