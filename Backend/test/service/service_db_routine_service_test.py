...
class ServiceDBRoutineServiceUnitTest(TestCase):
    def setUp(self):
        ...
        self.service_db_service = ServiceDBRoutineService(
            service_repository=self.service_repository_mock
        )
    ...
    def test_start_routine(self):
        ...
        self.assertEqual(
            9,
            len(self.service_repository_mock.create_service.mock_calls),
