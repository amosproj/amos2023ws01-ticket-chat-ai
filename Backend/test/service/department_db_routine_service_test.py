...
class DepartmentDBRoutineServiceUnitTest(TestCase):
    def setUp(self):
        ...
        self.department_db_service = DepartmentDBRoutineService(
            department_repository=self.department_repository_mock
        )
    ...
    def test_start_routine(self):
        ...
        self.assertEqual(
            6,
            len(self.department_repository_mock.create_department.mock_calls),
